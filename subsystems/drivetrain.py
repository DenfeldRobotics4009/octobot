...
class Drivetrain(Subsystem):
    ...
    def __init__(self, robot):
        ...
        self.drive_diagonal.setInvertedMotor(self.drive_diagonalMotorType.kRearLeft, True)
